...
plotme <- PNAcatch_long %>% 
  ...
  theme_bw() +
  labs(title = "Projection of a sample of small-scale fisheries catches in Pacific North America") +
  theme(axis.text.x = element_text(angle = 90)) +
  scale_x_discrete(breaks = c("2000", "2010", "2020", "2030", "2040", "2050"))
  
ggsave("myplot.png", path = "C:/Users/angmel/Documents/firstchapter/SAU_DBEM_RESULTS/AGGREGATE/")
