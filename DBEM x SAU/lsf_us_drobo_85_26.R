...
split_USA <- split(usa_lsf_drobo, usa_lsf_drobo$taxonID)
...
for(i in 1:length(usa_lsf_drobo$taxonID)){
  taxontemp <-as.character(usa_lsf_drobo$taxonID[i])
...
write_csv(USA26_DROBO, "C:/Users/angmel/Documents/MSc-small-scale-fisheries/SAU_DBEM_RESULTS/USA/GFDL26/errspp")
...
write_csv(USA85_DROBO, "C:/Users/angmel/Documents/MSc-small-scale-fisheries/SAU_DBEM_RESULTS/USA/GFDL85/errspp")
