...
split_me <- split(me_lsf_drobo, me_lsf_drobo$taxonID)
...
for(i in 1:length(me_lsf_drobo$taxonID)){
  taxontemp <-as.character(me_lsf_drobo$taxonID[i])
...
write_csv(Mexico26_DROBO, "C:/Users/angmel/Documents/MSc-small-scale-fisheries/SAU_DBEM_RESULTS/Mexico/GFDL26/errspp")
...
write_csv(Mexico85_DROBO, "C:/Users/angmel/Documents/MSc-small-scale-fisheries/SAU_DBEM_RESULTS/Mexico/GFDL85/errspp")
