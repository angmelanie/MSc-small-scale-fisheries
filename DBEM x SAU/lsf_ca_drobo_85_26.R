...
split_CA <- split(canada_lsf_DROBO, canada_lsf_DROBO$taxonID)
...
canada_lsf_DROBO$taxonID

# RCP: 2.6
errspp <- numeric()

for(i in 1:length(canada_lsf_DROBO$taxonID)){
  taxontemp <-as.character(canada_lsf_DROBO$taxonID[i])
...
write_csv(Canada85_DROBO, "C:/Users/angmel/Documents/MSc-small-scale-fisheries/SAU_DBEM_RESULTS/Canada/GFDL85/errspp")
