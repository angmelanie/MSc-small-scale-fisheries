...
MISTAKES <- anti_join(alaska_lsf_cygwin, cygwin_RCP85, by = "taxonID")

alaska_lsf_cygwin_partial <- anti_join(alaska_lsf_cygwin, MISTAKES)

errspp <- numeric()

for(i in 16:length(alaska_lsf_cygwin_partial$taxonID)){
...
write_csv(Alaska85_cygwin, "C:/Users/angmel/Documents/MSc-small-scale-fisheries/SAU_DBEM_RESULTS/Alaska/GFDL85/errspp85")
