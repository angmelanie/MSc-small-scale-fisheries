...
split_me <- split(me_ssf_drobo, me_ssf_drobo$taxonID)
...
for(i in 1:length(me_ssf_drobo$taxonID)){
  taxontemp <-as.character(me_ssf_drobo$taxonID[i])
...
Mexico26_DROBO <- errspp # CHANGE THIS FOR DROBO/CYGWIN
Mexico26_DROBO <- data.frame(Mexico26_DROBO) # make data frame format for saving
write_csv(Mexico26_DROBO, "C:/Users/angmel/Documents/MSc-small-scale-fisheries/SAU_DBEM_RESULTS/Mexico/GFDL26/SSF/errspp")
...
Mexico85_DROBO <- errspp # CHANGE THIS FOR DROBO/CYGWIN
Mexico85_DROBO <- data.frame(Mexico85_DROBO) # make data frame format for saving
write_csv(Mexico85_DROBO, "C:/Users/angmel/Documents/MSc-small-scale-fisheries/SAU_DBEM_RESULTS/Mexico/GFDL85/SSF/errspp")
