# SAU X DBEM: ALASKA VERSION 2.0
# This is for 75% catch
...
# CORRECTION VERSION 2 THERE IS CYGWIN
...
split_Alaska <- split(alaska_ssf_DROBO, alaska_ssf_DROBO$taxonID)
...
for(i in 1:length(alaska_ssf_DROBO$taxonID)){
  taxontemp <-as.character(alaska_ssf_DROBO$taxonID[i])
...
write_csv(Alaska26_DROBO, "C:/Users/angmel/Documents/MSc-small-scale-fisheries/SAU_DBEM_RESULTS/Alaska/GFDL26/SSF/errspp26ssf")
