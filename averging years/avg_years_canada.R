...
# LSf - 2.6 
path <- "C:/Users/angmel/Documents/MSc-small-scale-fisheries/SAU_DBEM_RESULTS/Canada/GFDL26/"

filename <- dir(path, pattern = ".csv")
filepath <- paste("C:/Users/angmel/Documents/MSc-small-scale-fisheries/SAU_DBEM_RESULTS/Canada/GFDL26/", filename, sep = "")
...
for (i in 1:length(filepath)){
  ...
  if (sum(smoothMean, na.rm = TRUE) > 0) {
    ...
    # final result
    newfilepath <- paste("C:/Users/angmel/Documents/MSc-small-scale-fisheries/SAU_DBEM_RESULTS/Canada/GFDL26/avg_new/", filename[i], "_avg.csv", sep = "")
...
for (i in 1:length(filepath)){
  ...
  if (sum(smoothMean, na.rm = TRUE) > 0) {
    ...
    # final result
    newfilepath <- paste("C:/Users/angmel/Documents/MSc-small-scale-fisheries/SAU_DBEM_RESULTS/Canada/GFDL85/avg_new/", filename[i], "_avg.csv", sep = "")
...
# SSF - 26
path <- "C:/Users/angmel/Documents/MSc-small-scale-fisheries/SAU_DBEM_RESULTS/Canada/GFDL26/SSF/"

filename <- dir(path, pattern = ".csv")
filepath <- paste("C:/Users/angmel/Documents/MSc-small-scale-fisheries/SAU_DBEM_RESULTS/Canada/GFDL26/SSF/", filename, sep = "")
...
for (i in 1:length(filepath)){
  ...
  if (sum(smoothMean, na.rm = TRUE) > 0) {
    ...
    # final result
    newfilepath <- paste("C:/Users/angmel/Documents/MSc-small-scale-fisheries/SAU_DBEM_RESULTS/Canada/GFDL26/SSF/avg_new/", filename[i], "_avg.csv", sep = "")
...
for (i in 1:length(filepath)){
  ...
  if (sum(smoothMean, na.rm = TRUE) > 0) {
    ...
    # final result
    newfilepath <- paste("C:/Users/angmel/Documents/MSc-small-scale-fisheries/SAU_DBEM_RESULTS/Canada/GFDL85/SSF/avg_new/", filename[i], "_avg.csv", sep = "")
