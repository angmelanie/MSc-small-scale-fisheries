...
# SSF - 8.5 
path <- "C:/Users/angmel/Documents/MSc-small-scale-fisheries/SAU_DBEM_RESULTS/SSF/85/"

filename <- dir(path, pattern = ".csv")
filepath <- paste("C:/Users/angmel/Documents/MSc-small-scale-fisheries/SAU_DBEM_RESULTS/SSF/85/", filename, sep = "")
...
if (sum(sau_dbem[2,], na.rm = TRUE) > 0) {
  ...
  # if (sum(smoothMean, na.rm = TRUE) > 0) {
    ...
    # final result
    newfilepath <- paste("C:/Users/angmel/Documents/MSc-small-scale-fisheries/SAU_DBEM_RESULTS/SSF/85/avg/", filename[i], "_avg.csv", sep = "")
...
ssf85 <- data.frame(errspp = unlist(errspp))

write_csv(ssf85, "C:/Users/angmel/Documents/MSc-small-scale-fisheries/SAU_DBEM_RESULTS/SSF/85/avg/ssf_85.csv")
